...
Most development discussion takes place on several Perl 6 mailing lists:
    ...
    * perl6-language discusses Perl 6, the language and features.
      L<mailto:perl6-language-subscribe@perl.org>
    * perl6-internals discusses the design and implementation of Parrot
      L<mailto:perl6-internals-subscribe@perl.org>
      and various languages targeting Parrot.
    * perl6-compiler discusses PGE, Pugs, and the interaction of various 
