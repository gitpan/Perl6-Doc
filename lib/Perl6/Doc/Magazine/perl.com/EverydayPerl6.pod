...
Magazine_Article_02 - Everyday Perl 6
...
While many of the changes in Perl 6 make it easier for people new to programming
or coming from other programming languages to understand the language, none of
the changes were made solely on those grounds. If your favorite part of Perl 5
syntax is that it uses an arrow for method dispatch on objects, don't be
dismayed that Perl 6 uses a dot instead. The designers carefully considered each
syntactic change to ensure that Perl 6 still has the Perlish nature I<and>
that the change was an overall improvement. Some Perl programmers delight in the
syntactic differences of the language, but some of those differences aren't that
important when compared to the big picture of Perl's culture (which includes the
...
See L<<a href="http://dev.perl.org/perl6/doc/design/syn/S02.html#Whitespace_and_Comments">Whitespace and Comments in Synopsis 02</a>> for more information.
...
For more information see L<<a href="http://dev.perl.org/perl6/doc/design/syn/S04.html">Synopsis 04</a>>.
...
For more information on subroutines in Perl 6, see L<<a href="http://dev.perl.org/perl6/doc/design/syn/S06.html">Synopsis 06</a>> and
Phil Crow's recent article L<<a href="http://www.perl.com/pub/a/2007/03/01/perl-6-parameter-passing.html">The Beauty of Perl 6 Parameter Passing</a>>. 
...
A prototype implementation of Perl 6 called L<<a href="http://www.pugscode.org/">pugs</a>>
