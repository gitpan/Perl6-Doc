...
Its published July 25, 2000 on perl.com and not changed since.
...
afternoon meeting was that it doesn't C<have> to be backward
...
B<Will Perl 6 be in C++?> : "Maybe."

B<When can we expect the grand plan ? :>
...
B<Will you look into technical infrastructure to support more constructive 
discussion than mailing lists can?>
...
B<Can you hint at some of the language changes ?>
...
B<One problem of language translation is that you lose comments and 
formatting.>
...
B<is there a possibility of getting a switch construction ?>
...
B<Will there be an ISO or ANSI standard for Perl ?> :
"We will be our own standards body."

B<How long have you been thinking about this ?> : "Since yesterday."

B<What about POD ?> : Larry said it was all negotiable.

B<Which languages will you borrow from this time ?> : "All of them."
...
B<Some people using Perl to develop large software want features like strong 
type checking. Is there a possibility of providing this ?>
