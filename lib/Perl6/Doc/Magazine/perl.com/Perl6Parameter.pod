...
Magazine_Article_03 - The Beauty of Perl 6 Parameter Passing
...
article will encourage you to try it. Begin by installing L<<a href="http://search.cpan.org/perldoc?pugs">Pugs</a>>,
a Perl 6 compiler implemented in Haskell. Note that you will also need 
Haskell (see directions in the Pugs I<INSTALL> file for how to get it). 
...
6 itself, C<package> identifies Perl 5 source code.  The <a href="http://search.cpan.org/v6?v6">v6</a> module lets you run some Perl 6 code
in Perl 5 programs.)  Immediately following is C<use v6;>, just as in
the original script.
...
How do you pass it on? Currying—that is, supplying one or more of the 
...
the I<examples/algorithms/> directory of the Pugs distribution. It's called
I<Newton.pm>. 
